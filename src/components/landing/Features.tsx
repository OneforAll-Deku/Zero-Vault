        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 border-4 border-black bg-black">
          {FEATURE_DATA.map((feature, i) => (
            <motion.div
              ...
              className="group relative bg-white aspect-square flex flex-col p-12 border-[2px] border-black overflow-hidden hover:bg-black transition-colors duration-500 cursor-none"
            >
